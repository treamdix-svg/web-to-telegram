...
app.all('/webhook', async (req, res) => {
  ...
  // 🚫 BLOK NOTIF KOSONG (PAGE LOAD / REFRESH)
  const isEmpty =
    data.produk === '-' &&
    data.nama === '-' &&
    data.kontak === '-'

  if (isEmpty && tipe === 'ORDER') {
    return res.send('IGNORED_EMPTY_ORDER')
  }
...
`
  ...
  if ((tipe === 'ORDER' || tipe === 'PAID') && SHEET_URL.startsWith('https')) {
